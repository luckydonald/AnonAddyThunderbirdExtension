...
Report: what testing already exists, what frameworks are available, and what the realistic options are for automating tests given this is a browser extension (Thunderbird MV3). Keep it concise — I need to advise the user on their options.
